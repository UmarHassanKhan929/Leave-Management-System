...
if(isset($postdata) && !empty($postdata))
{
  ...
  if($leave_days >= 10)
	  $sql = "INSERT INTO student_leave (user_id,date_from,leave_days,student_message,hod_approval,faculty_approval) VALUES 
  ($user_id,'$date_from',$leave_days,'$faculty_message','pending','approved')";
	else
	  $sql = "INSERT INTO student_leave (user_id,date_from,leave_days,student_message,hod_approval,
  faculty_approval) VALUES ($user_id,'$date_from',$leave_days,'$faculty_message','pending','pending')";
